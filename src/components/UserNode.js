          ...
          <div className="edit-button">
            ...
            >
              <Box sx={styleEdit} className="edit-modal">
                <div className="heading-modal">Edit Member</div>
                ...
                <div style={{ paddingTop: "5px", paddingLeft: "4%" }}>
                  ...
                  >
                    <Box sx={style} className="delete-modal">
                      <div className="heading-modal">Delete Member</div>

                      <div className="modal-last-line"></div>
                      <div style={{ paddingLeft: "3%", paddingTop: "2%" }}>
                        Are you sure, you want to delete member permanently ?
                      </div>
                      <div style={{ float: "right", paddingRight: "10px" }}>
                        <button className="team-add-button-modal">Yes</button>
                      </div>
                      <div
                        style={{
                          float: "right",
