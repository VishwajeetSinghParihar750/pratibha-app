...
function EmailOtp() {
  return (
    ...
    <div className='left'>
       ...
       New Password</b></p>
        <div className='reset-content'><p>We've sent you One Time Password OTP on your email for verification. Please enter your 6-digit OTP</p></div>
        </div>
       ...
       <div><h2> <img src={logo} className="logo" alt='anim' />&nbsp; Cyethack Solutions</h2></div>
        <div className='right-content-text'>
            ...
            <form style={{width:"70vh"}}>
                <h1 style={{textAlign:"center"}}><b>Email OTP</b></h1>
